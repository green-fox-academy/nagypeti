package day_02.practice; // Packages are the collection of java classes
...
public class Human {
  ...
  // Class
  // A general description of an object, a class can have
  // many different objects created with the given
  // states as parameters

  // Classes can have multiple state (field or data), any state
  // can have multiple behavior (method or subroutine)
